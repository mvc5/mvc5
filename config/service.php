...
return [
    ...
    'error\status'               => [Mvc5\Response\Status::class, 404],
    ...
    'resolver\service'           => new Service(Mvc5\Resolver\Service::class, [new Param('events')]),
    ...
    'service\locator'            => new Dependency('resolver\service'),
