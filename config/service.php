...
return [
    ...
    'exception\controller' => [Mvc5\Request\Exception\Controller::class, new Link],
    'exception\error'      => [Mvc5\Request\Exception::class, 'exception', 'exception\controller'],
    'exception\layout'     => [Mvc5\Request\Exception\ViewLayout::class, 'template' => 'exception'],
    ...
    'http\middleware'      => [Mvc5\Http\HttpMiddleware::class, 'service' => new Link, 'middleware' => new Param('middleware.web')],
    ...
    'login\redirect'       => [Mvc5\Session\Login\Redirect::class, new Plugin('session'), new Plugin('login\redirect\response')],
    ...
    'route\match\authenticate' => [Mvc5\Route\Match\Authenticate::class, 'login\redirect'],
